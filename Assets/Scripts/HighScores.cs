...
{
    const string privateCode = "FapsYQeZF0mVRGfPY6REQw8qOGGmuxNkis_gmbCC9jHQ";  //Key to Upload New Info
    const string publicCode = "62df38e38f40bf84ec88793c";   //Key to download
    ...
    IEnumerator DatabaseUpload(string userame, int score) //Called when sending new score to Website
    {
        ...
        {
            PlayerPrefs.SetInt(userame, score);
        }
    }
